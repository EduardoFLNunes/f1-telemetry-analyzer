...
def telemetry_status_payload() -> Dict[str, Any]:
    ...
    return {
        ...
        "visualSource": (track.get("visualGeometry") or {}).get("visualSource") or (track.get("metadata") or {}).get("visualSource"),
        "visualRenderMode": (track.get("visualGeometry") or {}).get("visualRenderMode") or (track.get("metadata") or {}).get("visualRenderMode"),
        "visualArtifactFixEnabled": (track.get("visualGeometry") or {}).get("visualArtifactFixEnabled") or (track.get("metadata") or {}).get("visualArtifactFixEnabled"),
        "falseCurveArtifactsRemoved": (track.get("visualGeometry") or {}).get("falseCurveArtifactsRemoved") or (track.get("metadata") or {}).get("falseCurveArtifactsRemoved"),
        "visualVersion": (track.get("visualGeometry") or {}).get("visualVersion") or (track.get("metadata") or {}).get("visualVersion"),
        "ribbonWidthMeters": (track.get("visualGeometry") or {}).get("ribbonWidthMeters") or (track.get("metadata") or {}).get("ribbonWidthMeters"),
        "centerlineMaxDisplacement": (track.get("visualGeometry") or {}).get("centerlineMaxDisplacement") or (track.get("metadata") or {}).get("centerlineMaxDisplacement"),
        "centerlineSmoothingEnabled": (track.get("visualGeometry") or {}).get("centerlineSmoothingEnabled") or (track.get("metadata") or {}).get("centerlineSmoothingEnabled"),
        "normalRecomputed": (track.get("visualGeometry") or {}).get("normalRecomputed") or (track.get("metadata") or {}).get("normalRecomputed"),
        "centerlineArtifactsDetected": (track.get("visualGeometry") or {}).get("centerlineArtifactsDetected") or (track.get("metadata") or {}).get("centerlineArtifactsDetected"),
        "centerlineArtifactsReduced": (track.get("visualGeometry") or {}).get("centerlineArtifactsReduced") or (track.get("metadata") or {}).get("centerlineArtifactsReduced"),
...
async def get_track_visual_geometry_debug():
    ...
    return {
        ...
        "visualSource": visual.get("visualSource") or (visual.get("metadata") or {}).get("visualSource"),
        "method": visual.get("method"),
        "visualVersion": visual.get("visualVersion"),
        "visualRenderMode": visual.get("visualRenderMode") or (visual.get("metadata") or {}).get("visualRenderMode"),
        "ribbonWidthMeters": visual.get("ribbonWidthMeters") or (visual.get("metadata") or {}).get("ribbonWidthMeters"),
        "centerlineMaxDisplacement": visual.get("centerlineMaxDisplacement") or (visual.get("metadata") or {}).get("centerlineMaxDisplacement"),
        "physicsUnaffected": visual.get("physicsUnaffected") or (visual.get("metadata") or {}).get("physicsUnaffected"),
        "visualArtifactFixEnabled": visual.get("visualArtifactFixEnabled"),
        "falseCurveArtifactsRemoved": visual.get("falseCurveArtifactsRemoved"),
        "centerlineSmoothingEnabled": visual.get("centerlineSmoothingEnabled"),
        "normalRecomputed": visual.get("normalRecomputed"),
        "centerlineArtifactsDetected": visual.get("centerlineArtifactsDetected"),
        "centerlineArtifactsReduced": visual.get("centerlineArtifactsReduced"),
        ...
        "exports": {
            ...
            "falseCurveReportJson": str(DEBUG_DIR / "track_visual_false_curves_report.json"),
            "centerlineArtifactsJson": str(DEBUG_DIR / "track_visual_centerline_artifacts.json"),
            "centerlineBeforeAfterSvg": str(DEBUG_DIR / "track_visual_centerline_before_after.svg"),
            "visualV2PreviewSvg": str(DEBUG_DIR / "track_visual_geometry_v2_preview.svg"),
            "physicsVsVisualV2Svg": str(DEBUG_DIR / "track_physics_vs_visual_v2.svg"),
            "ribbonPreviewSvg": str(DEBUG_DIR / "track_visual_ribbon_preview.svg"),
            "polygonVsRibbonSvg": str(DEBUG_DIR / "track_visual_polygon_vs_ribbon.svg"),
            "ribbonMetricsJson": str(DEBUG_DIR / "track_visual_ribbon_metrics.json"),
            "roadOnlyPreviewSvg": str(DEBUG_DIR / "track_visual_road_only_preview.svg"),
